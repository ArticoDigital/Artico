                ...
                <table class="container__table" role="presentation" border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
                    <tr class="container__row">
                        <td class="container__cell" width="100%" align="left" valign="top">
                            <h1 class="header h1" style="margin: 20px 0; line-height: 40px; font-family: Helvetica,Arial,sans-serif; color: #538BF4; text-align: center;">🎄¡PROMOCIÓN NAVIDEÑA!🤶</h1>
                            <h2 class="header h2" style="margin: 20px 0; line-height: 30px; font-family: Helvetica,Arial,sans-serif; color: #3B3B3B; font-weight: 500;">Hola {{$data['name']}} </h2>
